...
function queryElements(doc = document) {
  return {
    ...
    searchChatsBtn: doc.querySelector('#searchChatsBtn'),
    ...
    chatSearchModal: doc.querySelector('#chatSearchModal'),
    chatSearchInput: doc.querySelector('#chatSearchInput'),
    clearChatSearchBtn: doc.querySelector('#clearChatSearchBtn'),
    chatSearchToolbarDivider: doc.querySelector('#chatSearchToolbarDivider'),
    closeChatSearchBtn: doc.querySelector('#closeChatSearchBtn'),
    chatSearchHeading: doc.querySelector('#chatSearchHeading'),
    chatSearchResults: doc.querySelector('#chatSearchResults'),
