...
const { CURRENT_SCHEMA_VERSION, readFoldersDocument } = require('./record-validation');
const { deleteFolderRecoverably } = require('./mutation-coordinator');
...
async function deleteFolderAndUnpinSessions(folderId) {
  await deleteFolderRecoverably(folderId);
}
